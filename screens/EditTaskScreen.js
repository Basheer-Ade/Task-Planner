  ...
  if (!task) {
    return (
      <View style={styles.container}>
        <Text style={styles.heading}>No task selected</Text>
      </View>
    );
  }
    ...
    <ScrollView style={styles.container}>
      <View style={styles.headerBox}>
        ...
        <Text style={styles.subheading}>
          Modify task details and keep your planner up to date.
        </Text>
      </View>
      ...
      <TouchableOpacity style={styles.primaryButton} onPress={updateTask}>
